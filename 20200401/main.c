...
int main(int argc, char **argv)
{
	...
	// Get Arguments
	size_t len_args = (size_t)argc-1;
//	double args[len_args];
	double *args = malloc(len_args * sizeof(int));
	...
	double angle = PI/4;
	MULTIVECTOR v = {0,1,0,0,0,0,0,0}, a = {0,1,0,0,0,0,0,0}, b = {0,cos(angle), sin(angle),0,0,0,0,0}, Rab = {0};
