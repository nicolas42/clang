...
int multivector_main(void)
{
    ...
    multivector_t spinor1 = multivector_mul(2, multivector_vector(1,0,0), multivector_vector_spherical(1,TAU/8,TAU/4));
    multivector_t spinor2 = multivector_mul(2, multivector_vector(1,0,0), multivector_vector_spherical(1,TAU/8,TAU/4));
    multivector_mul(3, multivector_vector(1,0,0), spinor1, spinor2);

    printf("\n");
    printf("chirality???\n");
    printf("r = multivector_mul(2, trivector(3), trivector(4));\n");
