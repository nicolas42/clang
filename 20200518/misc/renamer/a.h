...
// regex for functions
// (init\(|scalar\(|vector\(|bivector\(|trivector\(|geometric_product\(|mul\(|rotate\(|rot\(|vector_spherical\(|print\(|print_scalar\(|print_vector\(|print_bivector\(|print_trivector\(|multivector_t\(|arena_allocate\(|arena_reset\()
...
multivector_t init(void)
{
    multivector_t a = arena_allocate(length);
...
multivector_t vector(double a, double b, double c)
{
    multivector_t arr = arena_allocate(length);
...
multivector_t geometric_product(multivector_t a, multivector_t b)
{
    ...
    multivector_t c = arena_allocate(length);
